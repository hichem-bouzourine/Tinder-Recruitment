                            ...
                            <table className="w-full bg-white shadow-md rounded-lg">
                                <thead className="bg-blue-500 text-white">
                                    <tr>
                                        ...
                                        <th className="p-4 text-left">Offer Location</th>
                                        <th className="p-4 text-left">Candidacy Time</th>
                                        <th className="p-4 text-left">Status</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {candidaciesStudent.map(candidacy => (
                                        <tr key={candidacy.id} className="border-b">
                                            <td className="p-4">{candidacy.offre.nom}</td>
                                            <td className="p-4">{candidacy.offre.type}</td>
                                            <td className="p-4">{candidacy.offre.localisation}</td>
                                            <td className="p-4">{candidacy.createdAt}</td>
                                            <td className="p-4">{candidacy.etat}</td>
                                        </tr>
                                    ))}
                                </tbody>
